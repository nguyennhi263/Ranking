...
public class ChineseCalendarConvert {
    ...
    public static int getLunarDay(int solarDay,int solarMonth,int solarYear)
    {
        //var lunar = new Lunar();
    ...
    public static int getLunarMonth(int solarDay,int solarMonth,int solarYear)
    {
        int index = solarYear - solar_1_1[0];
        int data = (solarYear << 9) | (solarMonth << 5) | (solarDay);
        int solar11 = 0;
